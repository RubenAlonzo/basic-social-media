...
<main class="container-lefted mt-5">
   ...
   <div class="my-3 p-3 bg-body rounded shadow col-md-8 ">
      <h3 class="border-bottom pb-2 mb-0">Welcome Ruben Alonzo!</h3>
      <br>
      ...
      <div class="d-flex text-muted pt-3">
         ...
         <div class="form-floating col-md-10">
            <form action="">
               <textarea class="form-control mb-3" rows="4" placeholder="Leave a comment here" id="floatingTextarea2"></textarea>
               <input class="form-control form-control-sm mb-3" id="formFileSm" type="file">
               <button type="button" class="btn btn-primary float-end">Publish</button>
            </form>
         </div>
      </div>
   </div>
